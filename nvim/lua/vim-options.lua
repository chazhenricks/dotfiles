...
vim.opt.virtualedit = "block" --lets you use visual block mode to select text after current line ends
vim.opt.inccommand = "split" -- preview chages in a dedicated split window
vim.opt.ignorecase = true -- ignore casing in vim commands
...
vim.g.mapleader = " "
-- local leader used for individual plugin keymaps
